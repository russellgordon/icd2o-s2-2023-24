...
Swift code that is authored in [[Playgrounds\|Playgrounds]] or Xcode can be kept tidy by adopting the following habits.
...
When authoring Swift code in [[Playgrounds\|Playgrounds]] or Xcode, you can automatically re-indent code using these two keyboard shortcuts in sequence:
